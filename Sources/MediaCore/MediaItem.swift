...
extension MediaItem {
    ...
    public static let sampleStreams: [MediaItem] = [
        MediaItem(
            title: String(localized: "Apple 官方 16:9 HLS 测试流 (高清晰·自适应)"),
            ...
            overview: String(localized: "Apple 官方 HTTP Live Streaming (HLS) 权威测试视频流，包含自适应多码率分片、立体声音频与内嵌字幕，用于验证现代媒体播放器的流式缓冲与分辨率自适应平滑切换。"),
            backdropUrl: URL(string: "https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?w=1920&q=80"),
            rating: 9.2,
            criticRating: 88,
            contentRating: "ALL",
            releaseDate: String(localized: "2024年 10月"),
            year: 2024,
            genres: [String(localized: "流媒体"), String(localized: "技术基准"), "4K HDR"],
        ...
        MediaItem(
            title: String(localized: "MDN Flower WebM 测试片段 (MPV 验证)"),
            ...
            containerHint: "webm",
            overview: String(localized: "Mozilla 开发者网络 (MDN) 官方标准 WebM 视频片段，用于验证 MPV 硬件加速、VP8/VP9 软硬解切换与色彩空间映射。"),
            backdropUrl: URL(string: "https://images.unsplash.com/photo-1508615039623-a25605d2b022?w=1920&q=80"),
            rating: 8.5,
            criticRating: 80,
            contentRating: "G",
            releaseDate: String(localized: "2023年"),
            year: 2023,
            genres: [String(localized: "自然"), String(localized: "微距"), String(localized: "色彩测试")],
        ...
        MediaItem(
            title: String(localized: "大雄兔 Big Buck Bunny (W3C 标准 MP4 直链)"),
            ...
            overview: String(localized: "Blender 基金会制作的著名开源 3D 动画短片。一只体型庞大却性情温柔祥和的大白兔，面对三只调皮捣蛋的森林恶霸小动物，决心用智慧和陷阱展开一场滑稽且精彩的森林大反击。"),
            ...
            contentRating: "G",
            releaseDate: String(localized: "2008年 4月10日"),
            year: 2008,
            genres: [String(localized: "动画"), String(localized: "喜剧"), String(localized: "短片")],
            studios: ["Blender Foundation", "Peach Open Movie Project"],
            people: [
                MediaPerson(
                    id: "p1",
                    name: "Sacha Goedegebure",
                    role: String(localized: "导演 / 编剧"),
                    type: "Director",
        ...
        MediaItem(
            title: String(localized: "Sintel 动画电影预告片 (W3C 标准 MP4 直链)"),
            ...
            overview: String(localized: "Blender 基金会打造的开源奇幻史诗动画短片。孤傲坚强的女孩 Sintel 在荒野风雪中救起了一只受重伤的小飞龙并悉心照料。当小龙被成年巨龙掠走后，她义无反顾地踏上孤独而艰险的漫漫寻友征途。"),
            ...
            contentRating: "PG",
            releaseDate: String(localized: "2010年 9月27日"),
            year: 2010,
            genres: [String(localized: "奇幻"), String(localized: "冒险"), String(localized: "史诗")],
            studios: ["Blender Foundation", "Durian Open Movie Project"],
            people: [
                MediaPerson(
                    id: "s1",
                    name: "Colin Levy",
                    role: String(localized: "导演"),
                    type: "Director",
                ...
                MediaPerson(
                    id: "s2",
                    name: "Halina Reijn",
                    role: String(localized: "Sintel (配音)"),
                    type: "Actor",
        ...
        MediaItem(
            title: String(localized: "高清 MP4 测试短片 1 (国内高速 CDN 直链)"),
            ...
            overview: String(localized: "国内主流高速云 CDN 节点加速的 MP4 H.264 基准测试视频，极速加载，适合测试国内弱网以及低延迟流媒体加载。"),
            backdropUrl: URL(string: "https://images.unsplash.com/photo-1518791841217-8f162f1e1131?w=1920&q=80"),
            rating: 7.8,
            year: 2024,
            genres: [String(localized: "CDN 直链"), String(localized: "基准测试")],
            videoStreamInfo: VideoStreamInfo(
                title: "1080p H264",
                codec: "h264",
                width: 1920,
        ...
        MediaItem(
            title: String(localized: "高清 MP4 测试短片 2 (国内高速 CDN 直链)"),
            ...
            overview: String(localized: "国内主流云端分发的多媒体测试素材，包含生动的高对比度动态场景，适合用于验证屏幕色彩与渲染帧率表现。"),
            backdropUrl: URL(string: "https://images.unsplash.com/photo-1574717024653-61fd2cf4d44d?w=1920&q=80"),
            rating: 7.9,
            year: 2024,
            genres: [String(localized: "CDN 直链"), String(localized: "色彩基准")],
            videoStreamInfo: VideoStreamInfo(
                title: "1080p H264",
                codec: "h264",
                width: 1920,
